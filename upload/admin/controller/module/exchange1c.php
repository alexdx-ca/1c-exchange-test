...
class ControllerModuleExchange1c extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['exchange1c_dont_use_name'])) {
			$data['exchange1c_dont_use_name'] = $this->request->post['exchange1c_dont_use_name'];
		} else {
			$data['exchange1c_dont_use_name'] = $this->config->get('exchange1c_dont_use_name');
		}
